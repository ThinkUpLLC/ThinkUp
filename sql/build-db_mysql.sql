...
CREATE TABLE `tt_follows` (
  ...
  `network` varchar(10) COLLATE utf8_general_ci NOT NULL DEFAULT 'twitter',
...
CREATE TABLE `tt_instances` (
  ...
  `network_username` varchar(255) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `tt_links` (
  ...
  `expanded_url` varchar(255) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `tt_owners` (
  ...
  `user_pwd` varchar(200) NOT NULL DEFAULT '',
...
CREATE TABLE `tt_plugins` (
  ...
  `version` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `tt_posts` (
  ...
  `author_username` varchar(50) COLLATE utf8_general_ci NOT NULL,
  `author_fullname` varchar(50) COLLATE utf8_general_ci NOT NULL,
  `author_avatar` varchar(255) COLLATE utf8_general_ci NOT NULL,
  `post_text` varchar(160) COLLATE utf8_general_ci NOT NULL,
  `source` varchar(255) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `tt_post_errors` (
  ...
  `error_text` varchar(255) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `tt_users` (
  ...
  `full_name` varchar(255) COLLATE utf8_general_ci NOT NULL,
  ...
  `found_in` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
