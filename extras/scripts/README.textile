...
* <code>migratedb</code> - run through all migrations start to finish and generate build-db_mysql.sql
* <code>migratedb-conf</code> - configuration
 
h3. Set up and run migratedb
...
Example: <code>./extras/scripts/migratedb</code>