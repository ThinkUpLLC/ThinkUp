...
CREATE TABLE tu_videos (
    ...
    post_key INT( 11 )  COMMENT 'ID of the row in the posts table for more information on this video.',
    ...
    INDEX(post_key)
)ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Extra data on videos by service users on a given network';
