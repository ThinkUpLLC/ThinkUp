...
<div class="append_20 alert helpful">
    ...
    <div class="">
    <p>The foursquare plugin collects your foursquare checkins and any associated links or comments. </p>
...
<li><a href="https://foursquare.com/oauth/register" target="_blank" style="text-decoration : underline;">Register a new consumer with foursquare</a></li>
<li> Set the Application Name to: Anything you like </li>
<li> Set the Application URL to: 
<small>
<code style="font-family:Courier;" id="clippy_2988">http{if $smarty.server.HTTPS}s{/if}://{$smarty.server.SERVER_NAME}{if $smarty.server.SERVER_PORT != '80'}:{$smarty.server.SERVER_PORT}{/if}{$site_root_path}</code>    </small>
...
<li> Set the Callback URL to: 
    <small>
<code style="font-family:Courier;" id="clippy_2988">http{if $smarty.server.HTTPS}s{/if}://{$smarty.server.SERVER_NAME}{if $smarty.server.SERVER_PORT != '80'}:{$smarty.server.SERVER_PORT}{/if}{$site_root_path}account/?p=foursquare</code>    </small>
    <object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000"
              width="100"
              height="14"
              class="clippy"
...
<li>Enter the provided Client ID and Client Secret here.</li></ol>
{/if}
