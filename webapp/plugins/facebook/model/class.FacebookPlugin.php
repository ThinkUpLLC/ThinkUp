<?php 
class FacebookPlugin implements iCrawlerPlugin, iWebappPlugin {
    ...
    public function getChildTabsUnderPosts() {
        ...
        $alltabds = new WebappTabDataset("all_facebook_posts", $pd, "getAllPosts", array($i->network_user_id, 15));
    ...
    public function getChildTabsUnderReplies() {
        ...
        $artabds = new WebappTabDataset("all_facebook_replies", $pd, "getAllReplies", array($i->network_user_id, 15));
    ...
    public function getChildTabsUnderFriends() {
        ...
        $poptabds = new WebappTabDataset("facebook_users", $fd, "getMostFollowedFollowees", array($i->network_user_id, 15));
    ...
    public function getChildTabsUnderFollowers() {
        ...
        $mftabds = new WebappTabDataset("facebook_users", $fd, "getMostFollowedFollowers", array($i->network_user_id, 15));
    ...
    public function getChildTabsUnderLinks() {
        ...
        $fltabds = new WebappTabDataset("links_from_friends", $ld, "getLinksByFriends", array($i->network_user_id));
