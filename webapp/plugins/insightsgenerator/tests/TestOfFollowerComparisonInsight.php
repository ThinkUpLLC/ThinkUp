...
class TestOfFollowerComparisonInsight extends ThinkUpInsightUnitTestCase {
    ...
    public function testOverFifty() {
        ...
        $this->assertEqual($result->text, '@testy has more followers than 50% of the 2 people @testy follows. '
            . "That means 1 of @testy's friends would reach a bigger audience if @testy retweeted them.");
    ...
    public function testAlternateHeadlines() {
        ...
        for ($i=2; $i<=4; $i++) {
            ...
            if ($i == 2) {
                $this->assertEqual($result->headline, '@testy could lend a hand');
                $this->assertEqual($result->text, '@testy has more followers than 80% of the 1000 people @testy '
                    . "follows. That means 800 of @testy's friends would reach a bigger audience if @testy "
                    . "retweeted them.");
            } else if ($i == 3) {
                $this->assertEqual($result->headline, '@testy has it good');
                $this->assertEqual($result->text, '@testy has more followers than 80% of the typical user @testy '
                    . "follows. That means 800 of @testy's friends would reach a bigger audience if @testy retweeted "
                    . "them.");
            } else if ($i ==4 ) {
