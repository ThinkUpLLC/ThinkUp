...
class TestOfNewDictionaryWordsInsight extends ThinkUpInsightUnitTestCase {
    public function setUp(){
        ...
        TimeHelper::setTime(1409341271); // Set it to the August 2014 words timeframe
    }
    ...
    public function testOneMatch() {
        ...
        $this->assertEqual('@testy used the word "FML" once since July 2014, and it appears to have caught on: '
            . "It's just been added to the Oxford English Dictionary.", $result->text);
        $data = unserialize($result->related_data);
        $this->assertEqual($data['hero_image']['img_link'], 'http://www.flickr.com/photos/bethanyking/822518337');
        $this->assertEqual($data['hero_image']['alt_text'], 'New words');
        $this->assertEqual($data['hero_image']['credit'], 'Bethany King: http://www.flickr.com/photos/bethanyking/');
        $this->assertEqual($data['hero_image']['url'], 'https://www.thinkup.com/assets/images/insights/2014-08/new_dictionary_words.jpg');
    ...
    public function testTwoMatches() {
        ...
        $this->assertEqual('The Oxford English Dictionary just added "humblebrag" and "clickbait" to their online '
    ...
    public function testFourMatches() {
        ...
        $this->assertEqual('The Oxford English Dictionary just added "hot mess", "clickbait", "YOLO", and "humblebrag" '
