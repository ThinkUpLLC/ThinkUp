...
class TestOfFavoriteFlashbacksInsight extends ThinkUpInsightUnitTestCase {
    ...
    public function testFavoriteFlashbacks() {
        ...
        $this->assertEqual('What @testeriffic favorited on this day in years past', $result->headline);
    ...
    private function buildData() {
        ...
        $builders[] = FixtureBuilder::build('favorites', array('post_id'=>133, 'author_user_id'=>7654321,
            'fav_of_user_id'=>7612345, 'network'=>'twitter', 'fav_timestamp' => $year_ago));
