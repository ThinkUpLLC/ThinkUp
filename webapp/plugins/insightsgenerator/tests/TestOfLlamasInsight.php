...
class TestOfLlamasInsight extends ThinkUpInsightUnitTestCase {
    ...
    public function testYesLlamas() {
        ...
        $this->assertEqual($result->text, "Two runaway llamas <a href='http://www.theverge.com/2015/2/26/8116693/live-the-internet-is-going-bananas-for-this-llama-chase'>took over Twitter yesterday</a>," .
