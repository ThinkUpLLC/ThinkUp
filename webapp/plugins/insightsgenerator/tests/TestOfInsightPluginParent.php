...
class TestOfInsightPluginParent extends ThinkUpUnitTestCase {
    ...
    public function testShouldGenerateEndOfYearAnnualInsight() {
        ...
        $this->assertTrue($insight_plugin_parent->shouldGenerateEndOfYearAnnualInsight('a_slug', $instance,
            $insight_date=$today));
        $this->assertFalse($insight_plugin_parent->shouldGenerateEndOfYearAnnualInsight('some_other_slug', $instance,
            $insight_date=$yesterday));
        $this->assertTrue($insight_plugin_parent->shouldGenerateEndOfYearAnnualInsight('some_other_slug', $instance,
            $insight_date=$yesterday, $regenerate_existing_insight=true));
        ...
        $this->assertTrue($insight_plugin_parent->shouldGenerateEndOfYearAnnualInsight('a_slug', $instance,
            $insight_date='today', $regenerate_existing_insight=false, $day_of_year=$day_of_year1));
        $this->assertTrue($insight_plugin_parent->shouldGenerateEndOfYearAnnualInsight('a_slug', $instance,
            $insight_date='today', $regenerate_existing_insight=false, $day_of_year=$day_of_year2));
        $this->assertFalse($insight_plugin_parent->shouldGenerateEndOfYearAnnualInsight('a_slug', $instance,
            $insight_date='today', $regenerate_existing_insight=false, $day_of_year=$day_of_year3));

        // Test with last week of posts
        $this->assertTrue($insight_plugin_parent->shouldGenerateEndOfYearAnnualInsight('a_slug', $instance,
            $insight_date='today', $regenerate_existing_insight=false, $day_of_year=null,
            $count_related_posts=13));
        $this->assertFalse($insight_plugin_parent->shouldGenerateEndOfYearAnnualInsight('a_slug', $instance,
            $insight_date='today', $regenerate_existing_insight=false, $day_of_year=null, $count_related_posts=0));
