...
class TestOfAgeAnalysisInsight extends ThinkUpUnitTestCase {
    ...
    public function testAgeAnalysisForFacebook() {
    	...
    	$this->assertEqual($result->headline, 'Age analysis');
    	...
    	$this->assertEqual($age_data[1]['18_25'], 1);
    	$this->assertEqual($age_data[1]['25_35'], 2);
    	$this->assertEqual($age_data[1]['35_45'], 1);
    ...
    private function buildData() {
    	...
    	$builders[] = FixtureBuilder::build('posts', array('id'=>236, 'post_id'=>236, 'author_user_id'=>8654323,
