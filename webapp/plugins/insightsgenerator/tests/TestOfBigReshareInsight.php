...
class TestOfBigReshareInsight extends ThinkUpInsightUnitTestCase {
    ...
    public function testSingleBigReshareBy2xFollowers() {
        ...
        'full_name'=>'User 1', 'description'=>'I am a user', 'avatar'=>'avatar.jpg', 'is_protected'=>0, 'follower_count'=>160,
        'network'=>'twitter'));
    ...
    public function testSingleBigReshareWithLessThan2xFollowers() {
        ...
        $builders[] = FixtureBuilder::build('users', array('user_id'=>'20', 'user_name'=>'user1',
        'full_name'=>'User 1', 'description'=>'I am a user', 'avatar'=>'avatar.jpg', 'is_protected'=>0, 'follower_count'=>100,
        'network'=>'twitter'));
    ...
    private function buildData() {
        ...
        'full_name'=>'Jacob', 'description'=>'I am a Jacob', 'is_protected'=>0, 'follower_count'=>320, 'network'=>'twitter'));
