...
class TestOfVerifiedListInsight extends ThinkUpInsightUnitTestCase {
    ...
    public function testAlternateText2() {
        ...
        $this->assertNotNull($result);
        $this->assertEqual($result->headline, "Verified!");
        $this->assertEqual($result->text, "@joetwitter is basking in the reflected Twitter-legitimacy of 1 ".
            "verified follower.");
    ...
    public function testAlternateText2a() {
        ...
        $this->assertNotNull($result);
        $this->assertEqual($result->headline, "Verified!");
        $this->assertEqual($result->text, "@joetwitter is basking in the reflected Twitter-legitimacy of 2 verified ".
            "followers.");
