...
class TestOfTopWordsInsight extends ThinkUpInsightUnitTestCase {
    ...
    public function testOfHashtagExlusion() {
        $builders = array();
        for ($i=0; $i<6; $i++) {
        ...
        $this->assertEqual($result->text, '@bookworm mentioned <b>&quot;many&quot;</b> more than anything else on '
            . 'Twitter last month, followed by &quot;hashtags&quot;, &quot;spread&quot;, &quot;kid&quot;, '
            . 'and &quot;helps&quot;.');
        $this->assertEqual($result->headline, 'Your most-used words last month');
