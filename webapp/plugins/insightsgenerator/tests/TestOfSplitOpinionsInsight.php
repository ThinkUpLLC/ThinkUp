...
class TestOfSplitOpinionsInsight extends ThinkUpUnitTestCase {
    ...
    public function testSplitOpinionsLikes() {
        ...
        'Your video My Great Video really touched a nerve 60% of people liked it and 40% disliked it.');
    }
    ...
    public function testSplitOpinionsDislikes() {
        ...
        $this->assertEqual($result->emphasis, 1);
        $this->assertEqual($result->text,
        'Your video My Great Video really touched a nerve 40% of people liked it and 60% disliked it.');
    }
    ...
    public function testSplitOpinionsEqualSplit() {
        ...
        $this->assertEqual($result->emphasis, 1);
        $this->assertEqual($result->text,
        'Your video My Great Video really touched a nerve 50% of people liked it and 50% disliked it.');
    }
