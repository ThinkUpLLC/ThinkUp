...
/**
 *
 * ThinkUp/webapp/plugins/insightsgenerator/tests/TestOfEOYThankedYouInsight.php
 *
...
require_once THINKUP_ROOT_PATH. 'webapp/plugins/insightsgenerator/insights/eoythankedyou.php';

class TestOfEOYThankedYouInsight extends ThinkUpInsightUnitTestCase {
    ...
    public function testConstructor() {
        $insight_plugin = new EOYThankedYouInsight();
        $this->assertIsA($insight_plugin, 'EOYThankedYouInsight' );
    }
    ...
    public function testTwitter() {
        ...
        $this->assertEqual($result->headline, 'These 2 people were thankful for @Thankster this year');
        $this->assertEqual($result->text, "Who says you can't build meaningful relationships on Twitter? "
            . "These 2 people shared an appreciation for @Thankster this year.");
        ...
        $this->assertEqual($data['hero_image']['img_link'],
            'https://www.flickr.com/photos/deapeajay/3024604627/sizes/z/');
        $this->assertEqual($data['button']['label'], 'Tell \'em "thanks" for the thanks');
    ...
    public function testFacebook() {
        ...
        $data = unserialize($result->related_data);
        $this->assertEqual($result->headline, '2 Facebook friends were thankful for Ms. Thankable this year');
        ...
        $this->assertEqual($data['hero_image']['alt_text'], '');
        $this->assertEqual($data['hero_image']['img_link'],
            'https://www.flickr.com/photos/dexxus/2981387336/sizes/z/');
        $this->assertEqual($data['button']['label'], 'Share your appreciation');
