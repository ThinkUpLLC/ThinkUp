...
class TestOfEOYPopularPicInsight extends ThinkUpInsightUnitTestCase {
    ...
    public function testTwitterNoMatch() {
        ...
        $this->assertIsA($result, "Insight");
        // $this->assertEqual(1, count($result->posts));
        $this->assertEqual("@ev yearns for the text-only days of Twitter", $result->headline);
        $this->assertEqual("@ev didn't share any pics on Twitter this year. Bummer! " .
            "We had a really great insight for photos. On the plus side: Guess @ev " .
            "won't need to worry about leaked nudes!", $result->text);
    ...
    public function testFacebookNoMatch() {
        ...
        $this->assertEqual("Mark Zuckerberg didn't share any pics on Facebook this year. " .
            "Bummer! We had a really great insight for photos. On the plus side: " .
            "Guess Mark Zuckerberg won't need to worry about leaked nudes!", $result->text);
