...
class TestOfInterestingFollowersInsight extends ThinkUpInsightUnitTestCase {
    ...
    public function testLeastLikely() {
        ...
        $this->assertEqual('@testuser has got an interesting new follower', $result->headline);
    ...
    public function testNewVerifiedFollower() {
        ...
        $this->assertNotNull($result);
        $this->assertIsA($result, "Insight");
        $this->assertPattern('/@testuser has got a new verified follower!/',
            $result->headline);
        $rendered = $this->getRenderedInsightInHTML($result);
    ...
    public function testLeastLikelyMutltiple() {
        ...
        $this->assertIsA($result, "Insight");
        $this->assertEqual('', $result->text);
        $this->assertEqual('@testuser has got 3 interesting new followers', $result->headline);
    ...
    public function testNewVerifiedNoTotal() {
        ...
        $this->assertNotNull($result);
        $this->assertIsA($result, "Insight");
        $this->assertEqual('@testuser has got 2 new verified followers!', $result->headline);
    ...
    public function testLocalFollowersInsightWithLocation() {
        ...
        $this->assertNotNull($result);
        $this->assertIsA($result, "Insight");
        $this->assertPattern('/@testuser has got 2 new followers nearby/',
            $result->headline);
    ...
    public function testLocalFollowersInsightWithHeaderImage() {
        ...
        $this->assertNotNull($result);
        $this->assertIsA($result, "Insight");
        $this->assertPattern('/@testuser has got a new follower nearby/',
            $result->headline);
