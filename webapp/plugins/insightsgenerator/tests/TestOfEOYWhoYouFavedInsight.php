...
class TestOfEOYWhoYouFavedInsight extends ThinkUpInsightUnitTestCase {
    ...
    public function testOneFavee() {
        ...
        $this->assertEqual($result->text, "If Twitter faves truly are an expression of our favorites, then this is "
            . "@georgemichael's favorite tweet-maker from 2014.");
    ...
    public function testMaxFaveesQualified() {
        ...
        $this->assertEqual($result->text, "If Twitter faves truly are an expression of our favorites, then these are "
            . "@georgemichael's favorite tweet-makers from 2014 (at least since March).");
        $data = unserialize($result->related_data);
