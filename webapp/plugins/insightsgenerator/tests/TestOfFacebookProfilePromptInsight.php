...
class TestOfFacebookProfilePromptInsight extends ThinkUpInsightUnitTestCase {
    ...
    public function testFirstRun() {
        ...
        $result = $this->insight_dao->getInsight('facebookprofileprompt', $instance->id, date('Y-m-d'));
        ...
        $last_baseline = $this->baseline_dao->getMostRecentInsightBaseline('facebookprofileprompted', $instance->id);
    ...
    public function testRecentBaseline() {
        ...
        $this->baseline_dao->insertInsightBaseline('facebookprofileprompted', $instance->id, 3,
