...
/*
 ...
 When: Sundays for Twitter and 1st of the month for Twitter
 */
...
class FollowerCountInsight extends InsightPluginParent implements InsightPlugin {
    ...
    public function generateInsight(Instance $instance, User $user, $last_week_of_posts, $number_days) {
        if ($instance->network == 'twitter') {
            ...
            $should_generate_insight = $this->shouldGenerateWeeklyInsight(
                $slug='follower_count_history_by_week_milestone',
