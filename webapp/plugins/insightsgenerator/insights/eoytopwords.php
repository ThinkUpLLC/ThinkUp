    ...
    public function generateInsight(Instance $instance, User $user, $last_week_of_posts, $number_days) {
        ...
        if ($should_generate_insight) {
            ...
            if ($instance->network == 'facebook') {
                $text = "How to describe $year? ".$this->username." used $first ".$words[0][1]." times on Facebook "
                    . "this year &mdash; more than any other word";
                if (!$rest) {
                    $text .= '.';
                } else {
                ...
                $text = "Would you say it's been a $first year? " . $this->username . " might. " . $this->username
                    . " mentioned $first ".$words[0][1]." times on $network in $year — more than any other word "
                    . "this year";
                if (!$rest) {
                    $text .= '.';
                } else {
