...
/*
 ...
 Description: Nudges you to update a potentially outdated Facebook profile
...
class FacebookProfilePromptInsight extends InsightPluginParent implements InsightPlugin {
    public function generateInsight(Instance $instance, User $user, $last_week_of_posts, $number_days) {
        ...
        if ($instance->network == 'facebook' &&
            ...
            $bl_slug = 'facebookprofileprompted';
            $insight_baseline_dao = DAOFactory::getDAO('InsightBaselineDAO');
            $last_baseline = $insight_baseline_dao->getMostRecentInsightBaseline($bl_slug, $instance->id);
            ...
            if ($ok_to_generate) {
                $insight = new Insight();
                $insight->slug = 'facebookprofileprompt';
                ...
                $insight_baseline_dao->insertInsightBaseline($bl_slug, $instance->id, $months);
            }
        }
