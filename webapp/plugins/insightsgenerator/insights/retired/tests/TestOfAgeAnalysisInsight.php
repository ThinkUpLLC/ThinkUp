...
class TestOfAgeAnalysisInsight extends ThinkUpInsightUnitTestCase {
    ...
    private function buildDataTeens() {
    	...
    	$builders[] = FixtureBuilder::build('posts', array('id'=>233, 'post_id'=>233, 'author_user_id'=>1,
			'author_username'=>'Teen Dude', 'author_fullname'=>'Teen Dude', 'author_avatar'=>'avatar.jpg',
        ...
        $builders[] = FixtureBuilder::build('users', array('user_id'=>1, 'user_name'=>'user',
            'full_name'=>'Teen Dude', 'gender'=>'female', 'birthday'=> '-'.(365*10).'d',
    ...
    private function buildDataYoung() {
    	...
    	$builders[] = FixtureBuilder::build('posts', array('id'=>233, 'post_id'=>233, 'author_user_id'=>1,
			'author_username'=>'Young Lady', 'author_fullname'=>'User1', 'author_avatar'=>'avatar.jpg',
			'network'=>'facebook', 'post_text'=>'This is a simple post.',
			'pub_date'=>$now, 'reply_count_cache'=>4, 'is_protected'=>0,'favlike_count_cache' => 4));
    ...
    private function buildDataAdults() {
    	...
    	$builders[] = FixtureBuilder::build('posts', array('id'=>233, 'post_id'=>233, 'author_user_id'=>1,
			'author_username'=>'Adult Person', 'author_fullname'=>'User1', 'author_avatar'=>'avatar.jpg',
			'network'=>'facebook', 'post_text'=>'This is a simple post.',
			'pub_date'=>$now, 'reply_count_cache'=>4, 'is_protected'=>0,'favlike_count_cache' => 4));
    ...
    private function buildDataMids() {
    	...
    	$builders[] = FixtureBuilder::build('posts', array('id'=>233, 'post_id'=>233, 'author_user_id'=>1,
			'author_username'=>'Mid-Life Gal', 'author_fullname'=>'User1', 'author_avatar'=>'avatar.jpg',
			'network'=>'facebook', 'post_text'=>'This is a simple post.',
			'pub_date'=>$now, 'reply_count_cache'=>4, 'is_protected'=>0,'favlike_count_cache' => 4));
    ...
    private function buildDataSeniors() {
    	...
    	$builders[] = FixtureBuilder::build('posts', array('id'=>233, 'post_id'=>233, 'author_user_id'=>1,
			'author_username'=>'Old Man', 'author_fullname'=>'User1', 'author_avatar'=>'avatar.jpg',
			'network'=>'facebook', 'post_text'=>'This is a simple post.',
			'pub_date'=>$now, 'reply_count_cache'=>4, 'is_protected'=>0,'favlike_count_cache' => 4));
