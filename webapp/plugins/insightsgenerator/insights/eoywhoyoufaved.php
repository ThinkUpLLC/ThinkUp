...
class EOYWhoYouFavedInsight extends InsightPluginParent implements InsightPlugin {
    ...
    public function generateInsight(Instance $instance, User $user, $last_week_of_posts, $number_days) {
        ...
        if (count($people) == 1) {
            ...
            $text = "If Twitter faves truly are an expression of our favorites, then this is ".$this->username
                . "'s favorite tweet-maker from $year".$qualified_year.".";
        } else {
            $title = $this->username."'s favorite people on Twitter, $year";
            $text = "If Twitter faves truly are an expression of our favorites, then these are ".$this->username
                . "'s favorite tweet-makers from $year".$qualified_year.".";
        }
