...
{capture name=permalink assign="permalink"}{$application_url}?u={$insight->instance->network_username|replace_accented_characters|urlencode}&amp;n={$insight->instance->network|urlencode}&amp;d={$insight->date|date_format:'%Y-%m-%d'}&amp;s={$insight->slug}{/capture}
