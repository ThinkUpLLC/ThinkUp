...
class TwitterCrawler {
        ...
        while ($this->api->available && $this->api->available_api_calls_for_crawler > 0 && $continue) {
            if ($mode != 0) { // in maintenance, not archiving mode
                ...
                if (!$finished_first_fetch) {
                    // $this->logger->logDebug("in 'first_archiving_fetch' clause with last_page_fetched_favorites $last_page_fetched_favorites", __METHOD__.','.__LINE__);
    ...
    private function archivingFavsFetch ($fcount, $last_fav_id, $last_page_fetched_favorites, $continue) {
        ...
        // $this->logger->logInfo("in archivingFavsFetch- last_page_fetched_favorites: $last_page_fetched_favorites", __METHOD__.','.__LINE__);
