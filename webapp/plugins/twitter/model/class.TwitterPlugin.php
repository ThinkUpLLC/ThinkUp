...
class TwitterPlugin implements CrawlerPlugin, DashboardPlugin, PostDetailPlugin {
    ...
    /**
     * defines the percentage of allocated api calls that each crawler function will use per run for 
     * non authed instances.
     */
    ...
    /**
     * defines the percentage of allocated api calls that each crawler function will use per run
     * for authed instances.
     */
