...
<li>Click "Services" and switch the YouTube Analytics API and YouTube Data API v3 to "On." Next, click "API Access" then "Create an OAuth 2.0 client ID."</li>
<li>
  Edit the settings for your new Client ID then click "Next." Make sure "Application Type" is set to "Web Application" and set the first line of Authorized Redirect URIs to<br>
    <small>
      <code style="font-family:Courier;" id="clippy_2988">{$thinkup_site_url}account/?p=youtube</code>
    </small>
...
To obtain a developer key visit: <a href="https://code.google.com/apis/youtube/dashboard/gwt/index.html#settings">https://code.google.com/apis/youtube/dashboard/gwt/index.html#settings</a>
