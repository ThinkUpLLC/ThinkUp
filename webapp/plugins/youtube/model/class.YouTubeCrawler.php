...
class YouTubeCrawler {
   ...
   /**
                ...
                if($api_comments > 0 && $api_comments > $comments_in_db) {
                    ...
                    do{
                        ...
                        foreach( $comments->feed->entry as $comment) {
                            echo("collected ".$comments_collected);
                            echo("max to collect ".$this->maximum_comments);
                            ...
                            if(isset($this->maximum_comments) && $comments_collected >= $this->maximum_comments) {
                                ...
                                "limit of ".$maximum_comments." comments.",__METHOD__.','.__LINE__);
                                break 2;
                            }
                            ...
                            // If the insert id is null we've already captured comments from this point so move on
    ...
    private function determineIfMoreCommentsExist($response, $video_id) {
