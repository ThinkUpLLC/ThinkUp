...
class TestOfYouTubeCrawler extends ThinkUpUnitTestCase {
    ...
    public function testFetchInstanceUserVideos() {
        ...
        $ytc = new YouTubeCrawler($this->instance, 'at');
        ...
        $this->assertEqual($video_one->title, 'My Slideshow');
        $this->assertEqual($video_one->post_text,
        ...
        $this->assertEqual($video_two->title, 'Same Page Video');
        $this->assertEqual($video_two->post_text, 'This video is on the same page');
        ...
        $this->assertEqual($video_three->title, 'My Slideshow');
        $this->assertEqual($video_three->post_text,
        'I created this video with the YouTube Slideshow Creator (http://www.youtube.com/upload)');
