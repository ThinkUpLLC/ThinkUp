<div class="section">
    <h2>Followers By Day {if $follower_count_history_by_day.trend}{if $follower_count_history_by_day.trend > 0}(<span style="color:green">+{else}<span style="color:red">{/if}{$follower_count_history_by_day.trend|number_format}</span>/day){/if}</h2>
...
<div class="section">
    <h2>Followers By Week {if $follower_count_history_by_week.trend != 0}{if $follower_count_history_by_week.trend > 0}(<span style="color:green">+{else}<span style="color:red">{/if}{$follower_count_history_by_week.trend|number_format}</span>/week){/if}</h2>
...
<div class="section">
    <h2>Followers By Month {if $follower_count_history_by_month.trend != 0}{if $follower_count_history_by_month.trend > 0}(<span style="color:green">+{else}<span style="color:red">{/if}{$follower_count_history_by_month.trend|number_format}</span>/month){/if}</h2>
