...
<a href="{$instaconnect_link}" class="btn btn-success add-account"><i class="icon-plus icon-white"></i> Add a Instagram User</a>
{/if}
...
<li>
    In "Description" put  <span style="font-family:Courier;">Thinkups Instagram access</span><br />
</li>
<li>
