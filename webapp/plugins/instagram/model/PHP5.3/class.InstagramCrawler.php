...
class InstagramCrawler {
    ...
    private function processPosts(Instagram\Collection\MediaCollection $posts, $network, $page_number) {
        ...
        foreach ($posts as $index=>$p) {
            ...
            $is_protected = ($network=='instagram')?1:0;
            //Get likes count
    ...
    private function storeFriends() {
        ...
        $network = ($user_id == $this->instance->network_user_id)?$this->instance->network:'instagram';
        $friends = InstagramGraphAPIAccessor::apiRequest('friends', $user_id, $access_token);
        ...
        if (isset($friends)) {
            ...
            foreach ($friends as $friend) {
                ...
                //$follower_details = InstagramGraphAPIAccessor::apiRequest('user', $follower_id, $this->access_token);
