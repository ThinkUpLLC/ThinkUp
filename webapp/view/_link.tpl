...
<div class="individual-tweet post clearfix">
  <div class="grid_1 alpha">
    <a href="http://twitter.com/{$l->container_post->author_username}"><img src="{$l->container_post->author_avatar}" class="avatar"/><img src="{$site_root_path}plugins/{$l->container_post->network}/assets/img/favicon.ico" class="service-icon"/></a>
  </div>
