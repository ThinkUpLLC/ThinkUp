...
<div class="individual-tweet clearfix{if $t->is_protected} private{/if}">
  <div class="grid_1 alpha">
    <a href="{$site_root_path}user/?u={$t->author_username}&i={$smarty.session.network_username}"><img src="{$t->author_avatar}" width="48" height="48" class="avatar"></a>
  </div>
  ...
  <div class="grid_3 right small">
    <a href="{$site_root_path}post/?t={$t->post_id}">{$t->adj_pub_date|relative_datetime}</a>
  </div>
