...
(function() {
  var $lastActiveDateGroup, animateContentShift, checkUsername, fakeUsernames, featureTest, pinDateMarker, setActiveDateGroup, setDateGroupData, setFixedPadding, setListOpenData, setNavHeight, timerUsername, wt,
  ...
  checkUsername = function($el) {
    ...
    return timerUsername = setTimeout(function() {
      ...
      $group = $el.parent();
      if (_ref = $el.val(), __indexOf.call(fakeUsernames, _ref) >= 0) {
      ...
      } else if (((_ref1 = $el.val().match(/^[\w]{3,15}$/gi)) != null ? _ref1.length : void 0) !== 1) {
        $group.removeClass("form-group-ok").addClass("form-group-warning");
  ...
  $(function() {
    var isjPMon, jPM;
    wt.loopThroughInsights(wt.canonical_insights, function() {
