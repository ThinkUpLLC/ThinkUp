 ...
 */
class DeleteOwnerController extends ThinkUpAdminController {
    /**
     * Required query string parameters
     * @var array oid = owner ID, a = 1 or 0, active or inactive
     */
    var $REQUIRED_PARAMS = array('oid');
    ...
    public function __construct($session_started=false) {
        ...
        $this->setViewTemplate('session.deleteOwner.tpl');
    ...
    public function adminControl(){
        if (!$this->is_missing_param) {
            ...
            $this->addToView('result', $owner_dao->deleteOwner($_GET["oid"]));
        }
