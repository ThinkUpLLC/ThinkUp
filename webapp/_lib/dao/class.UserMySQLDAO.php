...
class UserMySQLDAO extends PDODAO implements UserDAO {
    ...
    public function updateUser($user) {
        ...
        if (!$is_user_in_storage) {
            $q = "INSERT INTO #prefix#users (user_id, user_name, full_name, avatar, gender, birthday, location, ";
            $q .= "description, url, ";
            ...
            $q = "UPDATE #prefix#users SET full_name = :full_name, avatar = :avatar, gender = :gender, ";
            $q .= "birthday = :birthday, location = :location, ";
