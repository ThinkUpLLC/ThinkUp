...
class VideoMySQLDAO extends PostMySQLDAO implements VideoDAO  {
    ...
    public function updateVideoCounts($vals) {
        ...
        $q .= " WHERE internal_post_id=:post_id";
    ...
    public function getVideoByID($video_id, $network) {
        ...
        $q .= "po.network, vid.id, vid.internal_post_id, vid.title, vid.likes, vid.dislikes, vid.views, ";
        ...
        $q .= "FROM #prefix#posts po JOIN #prefix#videos vid ON po.id = vid.internal_post_id ";
