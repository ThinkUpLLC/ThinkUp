...
class SmartyThinkUp extends Smarty {
    ...
    public function fetch($template, $cache_key=null, $compile_id=null, $display=false) {
        if (! is_writable(THINKUP_COMPILED_VIEW_PATH) || ! is_writable(THINKUP_CACHE_PATH) ) {
            ...
            return str_replace(array('#THINKUP_BASE_URL#', '#WHOAMI#', '#COMPILE_DIR#', '#CACHE_DIR#', '#TMP_DIR#'),
            array(THINKUP_BASE_URL, $whoami, THINKUP_DEFAULT_COMPILED_VIEW_PATH, THINKUP_DEFAULT_CACHE_PATH, sys_get_temp_dir()),
