 ...
 * Video class
 *
 * This class represents a video posted on YouTube.
 *
...
class Video extends Post {
    /**
     * @var int Interal Unique Video ID
     */
    var $id;
    /**
    ...
    /**
     * @var string The description of this video on YouTube
     */
    var $description;
    /**
     * @var int Total number of likes this video has recieved
     */
    var $likes;
    /**
     * @var int Total number of dislikes this video has recieved
     */
    var $dislikes;
    /**
    ...
    public function __construct($row = false) {
        if ($row) {
            ...
            $this->id = $row['id'];
            $this->internal_post_id = $row['internal_post_id'];
