          ...
          <li>
            <ul class="side-subnav">
              <li{if $smarty.get.v eq ''} class="currentview"{/if}><br />
                <a href="index.php?u={$instance->network_username|urlencode}&n={$instance->network}">Dashboard</a>
              </li>
        {/if}
        {if $sidebar_menu}
        ...
        {if $instance}
            ...
            {if $least_likely_followers}
              <div class="clearfix">
                ...
                <a href="{$site_root_path}index.php?v=followers-leastlikely&u={$instance->network_username}&n={$instance->network}">More...</a></div>
              </div>
            {/if}
