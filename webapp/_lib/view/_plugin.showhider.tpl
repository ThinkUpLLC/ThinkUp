...
{if $is_configured}
<p>
    <a href="#" onclick="show_settings(); return false" class="btn btn-small"><i id="settings-icon" class="fa-chevron-down"></i> <span id="settings-flip-prompt">Show</span> Settings</a>
</p>
{/if}
