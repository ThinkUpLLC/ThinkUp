...
Click on the button below to back up your ThinkUp database. This new ThinkUp feature is in testing now; if it doesn't work, 
    run a mysqldump manually on your ThinkUp server.</p>
        </p>
    </div>

    <input type="button" id="login-save" name="Submit" style="margin: 20px 0px 0px 20px;"
    onclick="document.location.href='?backup=true'" class="tt-button ui-state-default ui-priority-secondary ui-corner-all" value="Backup Now">
