        ...
        <form class="input" name="form1" method="post" action="index.php?step=3">
          ...
          {include file="_usermessage.tpl" field="timezone"}
            ...
            <div class="grid_10 prefix_1 left">
              ...
              <option value=""{if $current_tz eq ''} selected{/if}>Select A Timezone:</option>
              ...
              <span class="input_information">Defaults to your browser's timezone, and will fall back to <a href="http://www.php.net/manual/en/function.date-default-timezone-get.php">php.ini's date.timezone value</a>. 
              <br />Current Time: <strong>{$current_server_time}</strong></span>
            </div>
          </div>
