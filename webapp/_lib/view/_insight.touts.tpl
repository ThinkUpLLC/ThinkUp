...
{elseif ($i->filename eq 'bestie')}
  {assign var='tout_headline' value="See who your BFF was each month on Twitter, Instagram and Facebook."}
...
{elseif ($i->filename eq 'responsetime')}
  {assign var='tout_headline' value="How often are you posting on Instagram, Twitter or Facebook? Find out!"}
