...
<div class="thinkup-canvas round-all container_24">
  <div class="clearfix">
        ...
        <ul id="top-level-sidenav"><br />
          <li>
            <ul class="side-subnav">
              <li><br><a href="{$site_root_path}index.php?u={$instance->network_username}&amp;n=twitter">Main Dashboard</a></li>
            </ul>
          </li>
        </ul>
      </div> <!-- /#nav-sidebar -->
    ...
    <div class="grid_20 omega prepend_20 append_20">
        ...
        <!-- begin user content -->
        {if $mutual_friends}
          <div class="clearfix grid_19 append_20">
