...
/**
 *
 * ThinkUp/webapp/_lib/view/plugins/modifier.link_usernames_to_network.php
 *
 ...
 *
 * Type:     modifier<br>
 * Name:     link_usernames_to_network<br>
 * Date:     July 4, 2009
 * Purpose:  links a Twitter username to their user page
 * Input:    status update text
 * Example:  {$status_html|link_usernames_to_network}
 ...
 * @return string
 */
function smarty_modifier_link_usernames_to_network($text, $network) {
    if ($network == 'twitter') {
        ...
        return preg_replace('/(^|[^a-z0-9_])@([a-z0-9_]+)/i',
        '$1<a href="https://instagram.com/$2">@$2</a>', $text);
    } else {
        return $text;
    }
}
