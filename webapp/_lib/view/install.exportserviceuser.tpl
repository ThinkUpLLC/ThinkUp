...
<div class="alert urgent" style="margin-top: 10px; padding: 0.5em 0.7em;"> 
    <p>
        ...
        <a href="http://thinkupapp.com/docs/troubleshoot/messages/mysqlfile.rst">ThinkUp 
...
<div class="alert urgent" style="margin-top: 10px; padding: 0.5em 0.7em;"> 
    <p>
        ...
        <a href="http://thinkupapp.com/docs/troubleshoot/messages/mysqlgrant.rst">ThinkUp 
        documentation</a> for more info on how to resolve this issue.
    </p>
</div>
{else}
