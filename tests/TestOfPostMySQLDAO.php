...
class TestOfPostMySQLDAO extends ThinkUpUnitTestCase {
    ...
    public function setUp() {
     ...
     protected function buildData() {
        ...
        'full_name'=>'Quotables', 'avatar'=>'avatar.jpg', 'is_protected'=>0, 'follower_count'=>80));

        $builders[] = FixtureBuilder::build('users', array('user_id'=>23, 'user_name'=>'user3', 
        'full_name'=>'User 3', 'avatar'=>'avatar.jpg', 'is_protected'=>0, 'follower_count'=>100));

        $builders[] = FixtureBuilder::build('users', array('user_id'=>24, 'user_name'=>'notonpublictimeline', 
        'full_name'=>'Not on Public Timeline', 'avatar'=>'avatar.jpg', 'is_protected'=>1, 
        'follower_count'=>100));
        ...
        'network_username'=>'shutterbug', 'is_public'=>1));

        $builders[] = FixtureBuilder::build('instances', array('network_user_id'=>19, 
        'network_username'=>'linkbaiter', 'is_public'=>1));

        $builders[] = FixtureBuilder::build('instances', array('network_user_id'=>23,
        'network_username'=>'user3', 'is_public'=>1));

        $builders[] = FixtureBuilder::build('instances', array('network_user_id'=>24, 
        'network_username'=>'notonpublictimeline', 'is_public'=>0));
        ...
        while ($counter < 40) {
            ...
            'post_text'=>'This is image post '.$counter, 'source'=>'Flickr', 
        ...
        while ($counter < 10) {
            ...
            if ( ($counter/2) == 0 ) {
                ...
                'author_username'=>'user1', 'author_fullname'=>'User 1', 'author_avatar'=>'avatar.jpg', 
                'post_text'=>'Hey @ev and @jack thanks for founding Twitter post $counter', 'source'=>'web', 
                'pub_date'=>'2006-03-01 00:$pseudo_minute:00', 'reply_count_cache'=>0, 'retweet_count_cache'=>0, 
                'location'=>'New Delhi', 'network'=>'twitter'));
            } else {
                $builders[] = FixtureBuilder::build('posts', array('post_id'=>$post_id, 'author_user_id'=>21, 
                'author_username'=>'user2', 'author_fullname'=>'User 2', 'author_avatar'=>'avatar.jpg', 
                'post_text'=>'Hey @ev and @jack should fix Twitter - post $counter', 'source'=>'web', 
                'pub_date'=>'2006-03-01 00:$pseudo_minute:00', 'reply_count_cache'=>0, 'retweet_count_cache'=>0, 
                'place'=>'New Delhi', 'network'=>'twitter'));
            }
        ...
        'author_username'=>'quoter', 'author_fullname'=>'Quoter of Quotables', 'author_avatar'=>'avatar.jpg', 
        ...
        'reply_retweet_distance'=>2000, 'is_geo_encoded'=>1));
        //retweet 2
        ...
        'in_retweet_of_post_id'=>0, 'location'=>'Dwarks, New Delhi, Delhi, India', 'geo'=>'28.635308,77.22496', 
        ...
        'author_username'=>'shutterbug', 'author_fullname'=>'Shutterbug', 'author_avatar'=>'avatar.jpg', 
        ...
        //Add user exchange
        $builders[] = FixtureBuilder::build('posts', array('post-id'=>139, 'author_user_id'=>20, 
        'author_username'=>'user1', 'author_fullname'=>'User 1', 'author_avatar'=>'avatar.jpg', 
        ...
        'author_username'=>'user3', 'author_fullname'=>'User 3', 'author_avatar'=>'avatar.jpg', 
        'post_text'=>'@user4 I\'m replying to a post not in the TT db', 'source'=>'web', 
        'pub_date'=>'2006-03-01 00:00:00', 'reply_count_cache'=>0, 'retweet_count_cache'=>0, 
        'in_reply_to_user_id'=>20, 'in_reply_to_post_id'=>150));
        ...
        'pub_date'=>'2006-03-01 00:00:00', 'reply_count_cache'=>0, 'retweet_count_cache'=>0, 
        'in_reply_to_user_id'=>20, 'in_reply_to_post_id'=>151));
        ...
        'author_avatar'=>'avatar.jpg', 'post_text'=>'This post should not be on the public timeline', 
        'source'=>'web', 'pub_date'=>'2006-03-01 00:00:00'));

        //To test ordering of replies on Facebook
        $builders[] = FixtureBuilder::build('posts', array('post_id'=>144, 'author_user_id'=>13, 
        'author_username'=>'ev', 'author_fullname'=>'Ev Williams', 'author_avatar'=>'avatar.jpg', 
        'post_text'=>'This is a Facebook post', 'source'=>'', 'pub_date'=>'2006-01-01 00:00:00', 
        'reply_count_cache'=>2, 'retweet_count_cache'=>0, 'network'=>'facebook'));

        $builders[] = FixtureBuilder::build('posts', array('post_id'=>145, 'author_user_id'=>20, 
        'author_username'=>'user1', 'author_fullname'=>'User 1', 'author_avatar'=>'avatar.jpg', 
        'post_text'=>'@ev Cool!', 'source'=>'', 'pub_date'=>'2006-01-03 00:00:00', 'reply_count_cache'=>0, 
        'retweet_count_cache'=>0, 'is_reply_by_friend'=>1, 'in_reply_to_post_id'=>144, 
        'location'=>'New Delhi, Delhi, India', 'reply_retweet_distance'=>0, 'is_geo_encoded'=>1, 
        'network'=>'facebook'));

        $builders[] = FixtureBuilder::build('posts', array('post_id'=>145, 'author_user_id'=>23, 
        'author_username'=>'user3', 'author_fullname'=>'User 3', 'author_avatar'=>'avatar.jpg', 
        'post_text'=>'@ev Rock on!', 'source'=>'', 'pub_date'=>'2006-03-02 00:00:00', 
    ...
    public function testAssignParent() {
        ...
        'author_username'=>'linkbaiter', 'author_fullname'=>'Link Baiter', 'author_avatar'=>'avatar.jpg', 
        'post_text'=>'This is parent post 1', 'source'=>'web', 'pub_date'=>'2006-03-01 00:01:00', 
        'reply_count_cache'=>1, 'retweet_count_cache'=>0));
        $builders[] = FixtureBuilder::build('posts', array('post_id'=>551, 'author_user_id'=>19, 
        'author_username'=>'linkbaiter', 'author_fullname'=>'Link Baiter', 'author_avatar'=>'avatar.jpg', 
        'post_text'=>'This is parent post 2', 'source'=>'web', 'pub_date'=>'2006-03-01 00:01:00', 
        'reply_count_cache'=>0, 'retweet_count_cache'=>0));

        //Add a post with the parent post 550
        $builders[] = FixtureBuilder::build('posts', array('post_id'=>552, 'author_user_id'=>19, 
        'author_username'=>'linkbaiter', 'author_fullname'=>'Link Baiter', 'author_avatar'=>'avatar.jpg', 
        'post_text'=>'This is a reply with the wrong parent', 'source'=>'web', 'pub_date'=>'2006-03-01 00:01:00', 
        'reply_count_cache'=>0, 'retweet_count_cache'=>0, 'in_reply_to_post_id'=>550));
    ...
    public function testGetMostRetweetedPostsByPublicInstancesInLastWeek() {
        ...
        while ($counter < 40) {
            $id += $counter;
            $builders[] = FixtureBuilder::build('posts', array('post_id'=>$id, 'author_user_id'=>23, 
            'author_username'=>'user3', 'author_fullname'=>'User 3', 'author_avatar'=>'avatar.jpg', 
            'post_text'=>'This is post with '.$counter.'retweets', 'source'=>'web', 
            'pub_date'=>'DATE_SUB(NOW(),INTERVAL '.$counter.'DAY', 'reply_count_cache'=>0, 
            'retweet_count_cache'=>$counter));
            $counter++;
        }
        $pdao = new PostMySQLDAO();
    ...
    public function testGetMostRepliedToPostsByPublicInstancesInLastWeek() {
        ...
        while ($counter < 40) {
            ...
            $builders[] = FixtureBuilder::build('posts', array('post_id'=>$id, 'author_user_id'=>23, 
            'author_username'=>'user3', 'author_fullname'=>'User 3', 'author_avatar'=>'avatar.jpg', 
            'post_text'=>'This is post with '.$counter.'replies', 'source'=>'web', 
            'pub_date'=>'DATE_SUB(NOW(), INTERVAL '.$counter.'DAY)', 'reply_count_cache'=>$counter, 
