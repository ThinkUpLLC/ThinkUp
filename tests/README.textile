...
The webapp tests contained in <code>tests/frontend_test.php</code> assumes you have a local installation of ThinkTank and that it is using your test database. Make sure you update your <code>config.inc.php</code> to point to the <code>thinktank_tests</code> database before running the webapp tests. 
