...
class TestOfOptionMySQLDAO extends ThinkUpUnitTestCase {
    ...
    public function testCreateOption() {
        ...
        $data = $data[0];
        $this->assertEqual($data['option_id'], 1);
    ...
    public function testDeleteOptionById() {
        ...
        // no options delete
        $this->assertEqual(0, $optiondao->deleteOption(1));
    ...
    public function testUpdateOptionById() {
        ...
        // no option to update
        $this->assertEqual(0, $optiondao->updateOption(1, 'value'));
    ...
    public function testGetOptionById() {
        ...
        // no options
        $this->assertNull( $optiondao->getOption(1) );
