...
class TestOfLogger extends ThinkUpBasicUnitTestCase {
    ...
    public function testHTMLOutput() {
        ...
        $this->assertPattern('/<td class="crawl-log-component">TestOfLogger: <\/td> <td class="control-group warning">This is a user info message<\/td>/i',
        $messages[sizeof($messages) - 4]);
        $this->assertPattern('/<td class="crawl-log-component">TestOfLogger: <\/td> <td class="control-group error">This is a user error message<\/td>/i',
        $messages[sizeof($messages) - 3]);
        $this->assertPattern('/<td class="crawl-log-component">TestOfLogger: <\/td> <td class="control-group error">This is an error message<\/td>/i',
        $messages[sizeof($messages) - 2]);
        $this->assertPattern('/<td class="crawl-log-component">TestOfLogger: <\/td> <td class="control-group success">This is a user success message<\/td>/i',
        $messages[sizeof($messages) - 1]);        
