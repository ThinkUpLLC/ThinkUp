...
class TestOfConfig extends ThinkUpUnitTestCase {
    ...
    public function testDBConfigValues() {
        ...
        $this->assertEqual($config->getValue('recaptcha_path'), '', "uses default app config value");
        ...
        $bvalue4 = array('namespace' => OptionDAO::APP_OPTIONS, 'option_name' => 'recaptcha_path',
        'option_value' => '/a/path');
        ...
        $this->assertEqual($config->getValue('recaptcha_path'), '/a/path', "uses default app config value");
        $this->assertEqual($config->getValue('recaptcha_private_key'), 'abc123', "uses default app config value");
        $this->assertEqual($config->getValue('recaptcha_public_key'), 'abc123public', "uses default app config value");
