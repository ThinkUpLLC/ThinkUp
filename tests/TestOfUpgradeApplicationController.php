...
class TestOfUpgradeApplicationController extends ThinkUpUnitTestCase {
    ...
    public function testNotEnoughAvailableFileSpace() {
        ...
        AppUpgraderDiskUtil::$DISK_SPACE_NEEDED = 107374182400; // set back to 100 megs
    }
    ...
    public function testGetLatestInfo() {
        ...
        AppUpgraderClient::$UPDATE_URL = THINKUP_WEBAPP_PATH . '../tests/data/update/bad_update_info.txt';
        try {
            $upgrade_controller->runUpdate($this->test_web_dir);
            $this->fail("Should throw an exception...");
        } catch(Exception $e) {
        ...
        AppUpgraderClient::$UPDATE_URL = THINKUP_WEBAPP_PATH . '../tests/data/update/old_update_info.txt';
        try {
            $upgrade_controller->runUpdate($this->test_web_dir);
            $this->fail("Should throw an exception...");
        } catch(Exception $e) {
