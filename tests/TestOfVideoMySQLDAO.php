...
class TestOfVideoMySQLDAO extends ThinkUpUnitTestCase {
    ...
    protected function buildData() {
        ...
        $builders[] = FixtureBuilder::build('posts', array(
            ...
            'post_text' => 'This is a youtube video ',
            'source' => '',
    ...
    public function testAddPost(){
        ...
        $video_attributes['title'] = "My Great Video";
        $video_attributes['post_text'] = "Watch my youtube video";
        ...
        $this->assertEqual($video->title, 'My Great Video');
        $this->assertEqual($video->post_text, 'Watch my youtube video');
    ...
    public function testGetVideoByIDExists() {
        ...
        $this->assertEqual($video->title, 'A random youtube video');
        $this->assertEqual($video->post_text, 'This is a youtube video ');
