...
class TestOfCountHistoryMySQLDAO extends ThinkUpUnitTestCase {
    ...
    public function testGroupMembershipGetDayHistoryNoGapsMilestoneNotInSight() {
        ...
        if ($todays_day_of_the_week == 0 ) {
            ...
            'type'=>'group_membership_count', 'count'=>14);
            ...
            'type'=>'group_membership_count', 'count'=>10);
            ...
            'type'=>'group_membership_count', 'count'=>12);
        ...
        $dao = new CountHistoryMySQLDAO();
        $result = $dao->getHistory('930061', 'twitter', 'DAY', 3, null, 'group_membership_count');
    ...
    public function testGroupMembershipGetDayHistoryNoGapsMilestoneInSight() {
        ...
        if ($todays_day_of_the_week == 0 ) {
            $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-2d',
            'type'=>'group_membership_count', 'count'=>940);
            $builder1 = FixtureBuilder::build('count_history', $count_history);

            $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-3d',
            'type'=>'group_membership_count', 'count'=>900);
            $builder2 = FixtureBuilder::build('count_history', $count_history);

            $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-4d',
            'type'=>'group_membership_count', 'count'=>920);
            $builder3 = FixtureBuilder::build('count_history', $count_history);
        } else {
            $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-1d',
            'type'=>'group_membership_count', 'count'=>940);
    ...
    public function testGroupMembershipGetDayHistoryWeekNoGaps() {
        ...
        $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-1d',
        'type'=>'group_membership_count', 'count'=>140);
        $builder1 = FixtureBuilder::build('count_history', $count_history);

        $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-2d',
        'type'=>'group_membership_count', 'count'=>139);
        $builder2 = FixtureBuilder::build('count_history', $count_history);

        $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-3d',
        'type'=>'group_membership_count', 'count'=>138);
        $builder3 = FixtureBuilder::build('count_history', $count_history);

        $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-4d',
        'type'=>'group_membership_count', 'count'=>137);
        ...
        'type'=>'group_membership_count', 'count'=>136);
        ...
        'type'=>'group_membership_count', 'count'=>135);
        ...
        'type'=>'group_membership_count','count'=>134);
        ...
        'type'=>'group_membership_count', 'count'=>133);
        ...
        'type'=>'group_membership_count', 'count'=>132);
        ...
        'type'=>'group_membership_count', 'count'=>131);
        ...
        'type'=>'group_membership_count', 'count'=>130);
        ...
        'type'=>'group_membership_count', 'count'=>129);
        ...
        'type'=>'group_membership_count', 'count'=>128);
        ...
        'type'=>'group_membership_count', 'count'=>127);
        $builder14 = FixtureBuilder::build('count_history', $count_history);

        $dao = new CountHistoryMySQLDAO();
        $result = $dao->getHistory('930061', 'twitter', 'WEEK', 3, null, 'group_membership_count');
        $this->assertEqual(sizeof($result), 4, '4 sets of data returned--history, trend, milestone, and vis_data');
    ...
    public function testGroupMembershipGetDayHistoryWithGaps() {
        ...
        $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-2d',
        'type'=>'group_membership_count', 'count'=>100);
        $builder2 = FixtureBuilder::build('count_history', $count_history);

        $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-5d',
        'type'=>'group_membership_count', 'count'=>120);
        $builder3 = FixtureBuilder::build('count_history', $count_history);

        $dao = new CountHistoryMySQLDAO();
        $result = $dao->getHistory('930061', 'twitter', 'DAY', 5, null, 'group_membership_count');
        $this->assertEqual(sizeof($result), 4, '4 sets of data returned--history, trend, milestone, and vis_data');
    ...
    public function testGroupMembershipTrendMillionPlusGroupMemberships() {
        ...
        $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-1d',
        'type'=>'group_membership_count', 'count'=>1772643);
        $builder1 = FixtureBuilder::build('count_history', $count_history);

        $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-2d',
        'type'=>'group_membership_count', 'count'=>1771684);
        $builder2 = FixtureBuilder::build('count_history', $count_history);

        $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-3d',
        'type'=>'group_membership_count', 'count'=>1771500);
        $builder3 = FixtureBuilder::build('count_history', $count_history);

        $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-4d',
        'type'=>'group_membership_count', 'count'=>1761500);
        $builder4 = FixtureBuilder::build('count_history', $count_history);

        $dao = new CountHistoryMySQLDAO();
        $result = $dao->getHistory('930061', 'twitter', 'DAY', 4, null, 'group_membership_count');
        $this->assertEqual(sizeof($result), 4, '4 sets of data returned--history, trend, milestone, and vis_data');
    ...
    public function testGroupMembershipTrendMillionPlusGroupMemberships2() {
        ...
        $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-1d',
        'type'=>'group_membership_count', 'count'=>1272643);
        $builder1 = FixtureBuilder::build('count_history', $count_history);

        $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-2d',
        'type'=>'group_membership_count', 'count'=>1271684);
        $builder2 = FixtureBuilder::build('count_history', $count_history);

        $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-3d',
        'type'=>'group_membership_count', 'count'=>1271500);
        $builder3 = FixtureBuilder::build('count_history', $count_history);

        $count_history = array('network_user_id'=>'930061', 'network'=>'twitter', 'date'=>'-4d',
        'type'=>'group_membership_count', 'count'=>1261500);
        $builder4 = FixtureBuilder::build('count_history', $count_history);
